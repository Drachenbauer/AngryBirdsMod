...
public class ModelStellaMoviePlayer extends ModelBase
{
	...
	public ModelStellaMoviePlayer.ArmPose rightArmPose = ModelStellaMoviePlayer.ArmPose.EMPTY;
	public ModelStellaMoviePlayer.ArmPose leftArmPose = ModelStellaMoviePlayer.ArmPose.EMPTY;
			...
			float headPitch, float scaleFactor, Entity entityIn)
	{
	    ...
	    if (this.leftArmPose == ModelStellaMoviePlayer.ArmPose.THROW_SPEAR && this.rightArmPose != ModelStellaMoviePlayer.ArmPose.BLOCK && this.rightArmPose != ModelStellaMoviePlayer.ArmPose.THROW_SPEAR && this.rightArmPose != ModelStellaMoviePlayer.ArmPose.BOW_AND_ARROW)
	    {
	    ...
	    if (this.rightArmPose == ModelStellaMoviePlayer.ArmPose.BOW_AND_ARROW)
	    {
	    ...
	    else if (this.leftArmPose == ModelStellaMoviePlayer.ArmPose.BOW_AND_ARROW && this.rightArmPose != ModelStellaMoviePlayer.ArmPose.THROW_SPEAR && this.rightArmPose != ModelStellaMoviePlayer.ArmPose.BLOCK)
	    {
	...
	public void setModelAttributes(ModelBase model)
	{
	    ...
	    if (model instanceof ModelStellaMoviePlayer)
	    {
	        ModelStellaMoviePlayer modelbiped = (ModelStellaMoviePlayer)model;
