...
@OnlyIn(Dist.CLIENT)
public class BubblesInflatedModel<T extends BubblesEntity> extends AgeableModel<T>
{
    ...
    public BubblesInflatedModel()
    {
        ...
        bone.func_217178_a("body", -20.0F, -20.0F, -20.0F, 40, 40, 40, 0.0F, 0, 0);
        bone.func_217178_a("beak", -1.0F, -16.0F, -23.0F, 2, 2, 3, 0.0F, 24, 0);
        bone.func_217178_a("head_feather_1", 0.0F, -28.0F, -17.0F, 0, 8, 1, 0.0F, 32, 7);
        ...
        bone.addChild(bone3);
        bone3.func_217178_a("tail_feather_1", 0.0F, 0.0F, 0.0F, 0, 1, 3, 0.0F, 0, 0);
        
        bone4 = new ModelRenderer(this);
        bone4.setRotationPoint(0.0F, 12.0F, 20.0F);
        setRotationAngle(bone4, -0.5236F, 0.0F, 0.0F);
        bone.addChild(bone4);
        bone4.func_217178_a("tail_feather_2", 0.0F, 0.0F, 0.0F, 0, 1, 3, 0.0F, 0, 0);
    }
    ...
    public void render(final T bubbles, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch)
    {
