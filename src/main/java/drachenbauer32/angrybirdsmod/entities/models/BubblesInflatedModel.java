...
public class BubblesInflatedModel extends EntityModel<BubblesInflatedEntity>
{
    ...
    public BubblesInflatedModel()
    {
        ...
        bone.func_217178_a("beak", -1.0F, -16.0F, -23.0F, 2, 2, 3, 0.0F, 5, 3);
        bone.func_217178_a("head_feather_1", 0.0F, -28.0F, -17.0F, 0, 8, 1, 0.0F, 0, 7);
        
        bone2 = new ModelRenderer(this);
        bone2.setRotationPoint(0.0F, -20.0F, -17.0F);
        setRotationAngle(bone2, -0.5236F, 0.0F, 0.0F);
        bone.addChild(bone2);
        bone.func_217178_a("head_feather_2", 0.0F, -4.0F, 1.0F, 0, 4, 1, 0.0F, 0, 11);
        
        bone3 = new ModelRenderer(this);
        bone3.setRotationPoint(0.0F, 12.0F, 20.0F);
        setRotationAngle(bone3, 0.5236F, 0.0F, 0.0F);
        bone.addChild(bone3);
        bone3.func_217178_a("tail_feather_1", 0.0F, 0.0F, 0.0F, 0, 1, 3, 0.0F, 0, 16);
        
        bone4 = new ModelRenderer(this);
        bone4.setRotationPoint(0.0F, 12.0F, 20.0F);
        setRotationAngle(bone4, -0.5236F, 0.0F, 0.0F);
        bone.addChild(bone4);
        bone4.func_217178_a("tail_feather_2", 0.0F, 0.0F, 0.0F, 0, 1, 3, 0.0F, 0, 16);
    }
    ...
    @Override
    public void func_225597_a_(BubblesInflatedEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float netHeadYaw, float headPitch)
    {
