...
public class IceBirdModel<T extends IceBirdEntity> extends AgeableModel<T>
{
    ...
    public IceBirdModel()
    {
        ...
        bone.addChild(bone2);
        bone2.func_217178_a("head_feather_1", -1.0F, -5.0F, -2.0F, 2, 5, 2, 0.0F, 0, 0);
        
        bone3 = new ModelRenderer(this);
        bone3.setRotationPoint(0.0F, -4.0F, 0.0F);
        setRotationAngle(bone3, -0.2618F, 0.0F, 0.0F);
        bone.addChild(bone3);
        bone3.func_217178_a("head_feather_2", -1.0F, -3.0F, -0.0F, 2, 3, 2, 0.0F, 0, 0);
        
        bone4 = new ModelRenderer(this);
        bone4.setRotationPoint(0.0F, 1.0F, 4.0F);
        setRotationAngle(bone4, -1.309F, 0.0F, 0.0F);
        bone.addChild(bone4);
        bone4.func_217178_a("tail_feather_1", -1.0F, -5.0F, -2.0F, 2, 5, 2, 0.0F, 0, 0);
        
        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(0.0F, 1.0F, 4.0F);
        setRotationAngle(bone5, -1.8326F, 0.0F, 0.0F);
        bone.addChild(bone5);
        bone5.func_217178_a("tail_feather_2", -1.0F, -3.0F, -0.0F, 2, 3, 2, 0.0F, 0, 0);
    }
   ...
   @Override
    ...
    public void render(final T ice_bird, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch)
    {
    ...
    @Override
    public void func_225597_a_(IceBirdEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float netHeadYaw, float headPitch)
    {
