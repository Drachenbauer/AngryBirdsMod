...
public class LucaModel<T extends LucaEntity> extends AgeableModel<T>
{
    ...
    public LucaModel()
    {
        ...
        bone.func_217178_a("head_feather_1", 0.0F, -8.0F, -2.0F, 0, 4, 2, 0.0F, 0, 0);
        
        bone2 = new ModelRenderer(this);
        bone2.setRotationPoint(0.0F, -4.0F, -2.0F);
        setRotationAngle(bone2, -0.7854F, 0.0F, 0.0F);
        bone.addChild(bone2);
        bone2.func_217178_a("head_feather_2", 0.0F, -4.0F, 0.0F, 0, 4, 2, 0.0F, 0, 0);
    ...
    public void render(final T luca, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch)
    {
    ...
    @Override
    public void func_225597_a_(LucaEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float netHeadYaw, float headPitch)
    {
