...
@OnlyIn(Dist.CLIENT)
public class ChuckModel<T extends ChuckEntity> extends AgeableModel<T>
{
    ...
    public void render(final T chuck, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch)
    {
    ...
    @Override
    public void func_225597_a_(ChuckEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float netHeadYaw, float headPitch)
    {
