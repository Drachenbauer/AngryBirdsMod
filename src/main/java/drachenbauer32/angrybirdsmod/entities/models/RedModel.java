...
@OnlyIn(Dist.CLIENT)
public class RedModel<T extends RedEntity> extends AgeableModel<T>
{
    ...
    public void render(final T red, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch)
    {
    ...
    @Override
    public void func_225597_a_(RedEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float netHeadYaw, float headPitch)
    {
