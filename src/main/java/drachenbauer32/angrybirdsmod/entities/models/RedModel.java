...
@OnlyIn(Dist.CLIENT)
public class RedModel extends EntityModel<RedEntity>
{
	...
	@Override
	public void render(RedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		bone.render(scale);
	}
	...
	@Override
    public void setRotationAngles(RedEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
