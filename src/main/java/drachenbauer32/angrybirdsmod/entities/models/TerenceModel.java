...
public class TerenceModel<T extends TerenceEntity> extends AgeableModel<T>
{
    ...
    public TerenceModel()
    {
        ...
        bone.func_217178_a("body", -10.0F, -10.0F, -10.0F, 20, 20, 20, 0.0F, 0, 0);
        bone.func_217178_a("beak", -1.0F, 5.0F, -12.0F, 2, 2, 2, 0.0F, 0, 12);
        bone.func_217178_a("head_feather_1", 0.0F, -14.0F, -2.0F, 0, 4, 6, 0.0F, 2, 2);
        bone.func_217178_a("tail_feather_1", 0.0F, 4.0F, 10.0F, 0, 2, 8, 0.0F, 0, 10);
        
        bone2 = new ModelRenderer(this);
        bone2.setRotationPoint(0.0F, -10.0F, -6.0F);
        setRotationAngle(bone2, 0.7854F, 0.0F, 0.0F);
        bone.addChild(bone2);
        bone2.func_217178_a("head_feather_2", 0.0F, 0.0F, 0.0F, 0, 4, 8, 0.0F, 0, 0);
        
        bone3 = new ModelRenderer(this);
        bone3.setRotationPoint(0.0F, 4.0F, 10.0F);
        setRotationAngle(bone3, 0.5236F, 0.0F, 0.0F);
        bone.addChild(bone3);
        bone3.func_217178_a("tail_feather_2",  0.0F, 0.0F, 0.0F, 0, 2, 8, 0.0F, 0, 10);
        
        bone4 = new ModelRenderer(this);
        bone4.setRotationPoint(0.0F, 4.0F, 10.0F);
        setRotationAngle(bone4, -0.5236F, 0.0F, 0.0F);
        bone.addChild(bone4);
        bone4.func_217178_a("tail_feather_3",  0.0F, 0.0F, 0.0F, 0, 2, 8, 0.0F, 0, 10);
    }
    ...
    public void render(final T terence, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch)
    {
    ...
    @Override
    public void func_225597_a_(TerenceEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float netHeadYaw, float headPitch)
    {
