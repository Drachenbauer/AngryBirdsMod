...
public class SilverModel<T extends SilverEntity> extends AgeableModel<T>
{
    ...
    public SilverModel()
    {
        ...
        bone.addBox("head_feather", -1.0F, -4.0F, 4.0F, 2, 2, 4, 0.0F, 24, 0);
        
        bone2 = new ModelRenderer(this);
        bone2.setRotationPoint(0.0F, 1.0F, 4.0F);
        setRotationAngle(bone2, -0.5236F, 0.0F, 0.0F);
        bone.addChild(bone2);
        bone2.addBox("tail_feather_1", 0.0F, 0.0F, 0.0F, 0, 1, 3, 0.0F, 0, 4);
        
        bone3 = new ModelRenderer(this);
        bone3.setRotationPoint(0.0F, 1.0F, 4.0F);
        setRotationAngle(bone3, 0.5236F, 0.0F, 0.0F);
        bone.addChild(bone3);
        bone3.addBox("tail_feather_2", 0.0F, 0.0F, 0.0F, 0, 1, 3, 0.0F, 0, 4);
    }
    ...
    @Override
    public void setRotationAngles(SilverEntity silver, float limbSwing, float limbSwingAmount, float ageInTicks,
