...
@OnlyIn(Dist.CLIENT)
public class MathildaModel extends EntityModel<MathildaEntity>
{
	...
	public MathildaModel()
	{
		...
		bone.cubeList.add(new ModelBox(bone, 25, 1, -1.0F, -4.0F, -5.0F, 2, 2, 1, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 24, 4, -1.0F, -2.0F, -6.0F, 2, 2, 2, 0.0F, false));
		bone.cubeList.add(new ModelBox(bone, 0, 0, 0.0F, -10.0F, -1.0F, 0, 4, 2, 0.0F, false));
		...
		bone.addChild(bone5);
		bone5.cubeList.add(new ModelBox(bone5, 0, 3, 0.0F, 0.0F, 0.0F, 0, 1, 4, 0.0F, false));
	}
	
	@Override
	public void render(MathildaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		bone.render(scale);
	}
	...
	@Override
	public void setRotationAngles(MathildaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
