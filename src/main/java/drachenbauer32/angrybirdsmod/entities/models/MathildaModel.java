...
public class MathildaModel<T extends MathildaEntity> extends AgeableModel<T>
{
    ...
    public MathildaModel()
    {
        ...
        bone.addBox("beak_upper", -1.0F, -4.0F, -5.0F, 2, 2, 1, 0.0F, 25, 1);
        bone.addBox("beak_lower", -1.0F, -2.0F, -6.0F, 2, 2, 2, 0.0F, 24, 4);
        bone.addBox("head_feather_1", 0.0F, -10.0F, -1.0F, 0, 4, 2, 0.0F, 0, 0);
        ...
        bone.addChild(bone4);
        bone4.addBox("tail_feather_2", 0.0F, 0.0F, 0.0F, 0, 1, 4, 0.0F, 0, 3);
        
        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(0.0F, 1.0F, 4.0F);
        setRotationAngle(bone5, -0.5236F, 0.0F, 0.0F);
        bone.addChild(bone5);
        bone5.addBox("tail_feather_3", 0.0F, 0.0F, 0.0F, 0, 1, 4, 0.0F, 0, 3);
    }
    ...
    @Override
    public void setRotationAngles(MathildaEntity mathilda, float limbSwing, float limbSwingAmount, float ageInTicks,
