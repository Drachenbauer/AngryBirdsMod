...
@OnlyIn(Dist.CLIENT)
public class HalModel extends EntityModel<HalEntity>
{
	...
	@Override
    public void render(HalEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        bone.render(scale);
    }
    ...
    @Override
    public void setRotationAngles(HalEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
