...
public class HalModel<T extends HalEntity> extends AgeableModel<T>
{
    ...
    public HalModel()
    {
        ...
        bone.func_217178_a("beak", -2.0F, -2.0F, -12.0F, 4, 5, 8, 0.0F, 25, 0);
        bone.func_217178_a("head_feather_1", 0.0F, -8.0F, -1.0F, 0, 4, 2, 0.0F, 0, 0);
        bone.func_217178_a("tail_feather_1", 0.0F, 1.0F, 4.0F, 0, 2, 2, 0.0F, 0, 4);
        ...
        bone.addChild(bone4);
        bone4.func_217178_a("tail_feather_2", 0.0F, -1.0F, 0.0F, 0, 2, 3, 0.0F, 0, 3);
        
        bone5 = new ModelRenderer(this);
        bone5.setRotationPoint(0.0F, 2.0F, 4.0F);
        setRotationAngle(bone5, 1.0472F, 0.0F, 0.0F);
        bone.addChild(bone5);
        bone5.func_217178_a("tail_feather_3", 0.0F, -1.0F, 0.0F, 0, 2, 4, 0.0F, 0, 2);
    }
    ...
    public void render(final T hal, final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch)
    {
    ...
    @Override
    public void func_225597_a_(HalEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float netHeadYaw, float headPitch)
    {
