...
@OnlyIn(Dist.CLIENT)
public class ChuckShotModel extends EntityModel<ChuckShotEntity>
{
    ...
    @Override
    public void render(ChuckShotEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        bone.render(scale);
    }
