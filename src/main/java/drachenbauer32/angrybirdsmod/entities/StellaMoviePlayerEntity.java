...
@OnlyIn(Dist.CLIENT)
public class StellaMoviePlayerEntity extends AbstractClientPlayerEntity
{
    ...
    public StellaMoviePlayerEntity(Minecraft p_i50990_1_, ClientWorld p_i50990_2_, ClientPlayNetHandler p_i50990_3_, StatisticsManager p_i50990_4_, ClientRecipeBook p_i50990_5_)
    {
    ...
    public void updateSyncFields(StellaMoviePlayerEntity old)
    {
