...
public class BirdShotEntity extends AbstractArrowEntity
{
    private static final DataParameter<Integer> COLOR = EntityDataManager.createKey(BirdShotEntity.class, DataSerializers.VARINT);
    private Potion potion = Potions.EMPTY;
    private final Set<EffectInstance> customPotionEffects = Sets.newHashSet();
    private boolean fixedColor;
    
    public BirdShotEntity(EntityType<? extends BirdShotEntity> type, World worldIn)
    {
        super(type, worldIn);
    }
    
    public BirdShotEntity(EntityType<? extends BirdShotEntity> type, World worldIn, double x, double y, double z)
    {
        super(type, x, y, z, worldIn);
    }
    
    public BirdShotEntity(EntityType<? extends BirdShotEntity> type, World worldIn, LivingEntity shooter)
    {
