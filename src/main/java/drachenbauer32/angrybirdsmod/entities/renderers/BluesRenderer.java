...
@OnlyIn(Dist.CLIENT)
public class BluesRenderer extends LivingRenderer<BluesEntity, BluesTrioModel>
{
    private static final ResourceLocation BLUES_TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/entity/blues_trio.png");
