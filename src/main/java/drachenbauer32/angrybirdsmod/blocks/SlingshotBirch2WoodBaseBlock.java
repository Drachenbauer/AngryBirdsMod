...
public class SlingshotBirch2WoodBaseBlock extends Block
{
    protected static final VoxelShape NORTH_AABB = Block.makeCuboidShape(0.0D, 4.0D, 8.0D, 16.0D, 16.0D, 12.0D);
    protected static final VoxelShape EAST_AABB = Block.makeCuboidShape(4.0D, 4.0D, 0.0D, 8.0D, 16.0D, 16.0D);
    protected static final VoxelShape SOUTH_AABB = Block.makeCuboidShape(0.0D, 4.0D, 4.0D, 16.0D, 16.0D, 8.0D);
    protected static final VoxelShape WEST_AABB = Block.makeCuboidShape(8.0D, 4.0D, 0.0D, 12.0D, 16.0D, 16.0D);
    public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
    
    public SlingshotBirch2WoodBaseBlock(String name, Properties properties)
    {
        super(properties);
    ...
    {
        return new ItemStack(AngryBirdsBlocks.slingshot_birch_2_block);
    }
